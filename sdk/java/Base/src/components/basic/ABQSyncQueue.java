 ...
 * @param <T>
 */
public class ABQSyncQueue<T extends Message> extends CSenseComponent {
    public final IInPort<T> in = newInputPort(this, "dataIn");
    public final IOutPort<T> out = newOutputPort(this, "dataOut");
    protected final BlockingQueue<T> _queue;
    ...
    public ABQSyncQueue(int capacity) throws CSenseException {
	super();
