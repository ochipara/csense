 ...
 * @param <T>
 */
public class CSensePriorityQueue<T> {
    protected final PriorityQueue<T> _list;
    ...
    public CSensePriorityQueue(int capacity) {
	_list = new PriorityQueue<T>(capacity);
	_capacity = capacity;
    }
