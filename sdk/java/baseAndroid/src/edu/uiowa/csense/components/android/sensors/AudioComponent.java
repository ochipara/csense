...
import edu.uiowa.csense.runtime.concurrent.CSenseInnerThread;
...
//		    Log.d(TAG, "remaining " + getAvailableMessages());
	...
	if (_bufferSize < AudioRecord.getMinBufferSize(_sRate, AudioFormat.CHANNEL_IN_MONO, _audioFormat)){ 				
	    throw new CSenseException(CSenseError.CONFIGURATION_ERROR, "Minumum buffer size below requirement");
	}		
    }
