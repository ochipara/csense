...
import compiler.checks.ConnectedPorts;
import compiler.checks.PartitionChecks;
import compiler.matlab.MatlabCodegen;
...
import compiler.transformations.ExpandFanIn;
import compiler.transformations.ExpandFanOut;
import compiler.transformations.ExpandGroup;
import compiler.transformations.GenerateAppGraph;
import compiler.transformations.RemoveUnusedOptionalPorts;
import compiler.transformations.collapsematlab.CollapseMatlabGroup;
import compiler.transformations.partition.QuickPartition2;
import compiler.transformations.types.CheckTypes;
import compiler.transformations.types.OptimizedTypeInference;
import compiler.transformations.types.SimpleTypeInference;
...
import project.resources.JarResource;
...
public abstract class CompileTargetProcessor extends TargetProcessor {
    ...
    protected void newEclipseProjectForAndroid(Project project)
	    throws CompilerException {
	try {
	    Target target = project.getTarget();
	...
	try {
	    ...
	    coder.append("\t<name>" + target.getProjectName() + "</name>\n");
